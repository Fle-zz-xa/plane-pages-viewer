...
import { PlanePage, createPage } from '@/lib/plane-api';
...
export function CreatePageModal({ allPages, defaultParentId, onClose, onCreated }: Props) {
  ...
  // Flat list for parent dropdown, exclude folders that are deeply nested for UX
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-gray-900">
              {isFolder ? 'Nieuwe map' : 'Nieuwe pagina'}
            </h2>
          </div>
